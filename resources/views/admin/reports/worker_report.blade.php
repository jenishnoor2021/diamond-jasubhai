      ...
      <div class="card-body">
        ...
        <form action="{{ route('generate-worker-pdf') }}" id="myWorkerForm" method="get">
          ...
          <div class="row">
            ...
            <div class="col-3">
              <div class="form-group">
                <label for="which_diamond">Date</label>
        ...
        <div class="table-responsive">
          <table id="exportworkerTable_{{ $worker->id }}" class="table align-items-center table-flush table-borderless">
            ...
            <tbody>
              ...
              ?>
              @php
              $workerData = $data->where('worker_name', $worker->fname);

              // Get first issue_weight
              // $firstIssueWeight = optional($workerData->first())->issue_weight;
